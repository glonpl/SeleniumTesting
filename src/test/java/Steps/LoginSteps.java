...
public class LoginSteps extends Steps {
    ...
    public void whenIWilladdInvalidAuthors() {
        driver.findElement(By.name("FirstName")).sendKeys("abcd");
        driver.findElement(By.id("LastName")).sendKeys("a");
        driver.findElement(By.id("CreateButton")).submit();

    }

    @Then("Zobaczę komunikat o niepowodzeniu")
    public void thenIWillseeFailMessage() {
        WebElement validation = driver.findElement(By.className("text-danger"));
        Assert.assertTrue(validation.getText().contains("First Name must start with capital letter"));
    }

    @When("Spróbuję dodać autora bez imienia")
    public void whenIWilladdEmptyNameAuthors() {


        driver.findElement(By.id("LastName")).sendKeys("Arecki");
        driver.findElement(By.id("CreateButton")).submit();

    }

    @Then("Zobaczę komunikat o pustym polu")
    public void thenIWillseeEmptyFailMessage() {
        WebElement validation = driver.findElement(By.className("text-danger"));
        Assert.assertTrue(validation.getText().contains("First Name is required."));
    }
